...
% --- PENGATURAN HEADER & FOOTER DENGAN LOGO SAKAPINTA ---
\pagestyle{fancy}
\fancyhf{}
\lhead{\raisebox{-0.08cm}{\includegraphics[height=0.45cm]{figures/Sakapinta.png}}\hspace{0.2cm}\textit{\footnotesize Sakapinta --- Tiang Penyangga Keputusan Stok UMKM}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/outlier_detection_iqr.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{figures/time_series_decomposition.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{figures/quantile_forecast_uncertainty.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\textwidth]{figures/model_benchmark_comparison.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.82\textwidth]{figures/dashboard_overview.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.82\textwidth]{figures/dashboard_matrix_xai.png}
