...
% --- PENGATURAN HEADER & FOOTER DENGAN WATERMARK LOGO DI TENGAH HALAMAN ---
\pagestyle{fancy}
\fancyhf{}
\lhead{\textit{\footnotesize SAKAPINTA --- Tiang Penyangga Keputusan Stok UMKM}}
\rhead{\textit{\footnotesize COMPFEST 18 AIC}}
\cfoot{\thepage%
  \begin{tikzpicture}[remember picture, overlay]
    \node[opacity=0.035, inner sep=0pt] at (current page.center) {
      \includegraphics[width=9.5cm]{figures/Sakapinta.png}
    };
  \end{tikzpicture}%
}
...
\begin{titlepage}
    ...
    \begin{minipage}{0.92\textwidth}
        \footnotesize
        \textbf{Nama Tim:} KKN (Kelompok Kecerdasan Neural)\\[0.25cm]
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.72\textwidth]{figures/outlier_detection_iqr.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/time_series_decomposition.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/quantile_forecast_uncertainty.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.68\textwidth]{figures/model_benchmark_comparison.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{figures/dashboard_overview.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.78\textwidth]{figures/dashboard_matrix_xai.png}
