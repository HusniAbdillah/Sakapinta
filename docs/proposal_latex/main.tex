...
% --- HALAMAN JUDUL (ANONIM - TANPA NAMA INSTITUSI/KAMPUS) ---
\begin{titlepage}
    \centering
    \vspace*{1.5cm}
    
    {\LARGE \textbf{PROPOSAL INOVASI ARTIFICIAL INTELLIGENCE}\par}
    \vspace{0.5cm}
    ...
    \vspace{0.4cm}
    {\huge \textbf{SAKAPINTA: SISTEM PENDUKUNG KEPUTUSAN PRESKRIPTIF BERBASIS MULTI-QUANTILE GRADIENT BOOSTING DAN STOCHASTIC BUFFER UNTUK OPTIMASI PERSEDIAAN RITEL UMKM INDONESIA}\par}
    \vspace{0.4cm}
    \rule{\linewidth}{1.5pt}\par
    \vspace{0.5cm}
    ...
    \begin{minipage}{0.85\textwidth}
        ...
        \textbf{Nama Tim:} KKN (Kelompok Kecerdasan Neural)\\[0.4cm]
        \begin{tabular}{ll}
