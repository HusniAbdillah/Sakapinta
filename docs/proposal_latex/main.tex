...
\begin{titlepage}
    ...
    {\small \textbf{AI INNOVATION CHALLENGE 2026 — COMPFEST 18}\par}
    \vspace{0.1cm}
    {\footnotesize \textbf{Tema: AI for the Backbone of the Economy (Pilar: Smart Commerce \& Smart Logistics)}\par}
    
    \vspace{0.6cm}
    \includegraphics[width=2.4cm]{figures/Sakapinta.png}\par
    \vspace{0.3cm}
    ...
    \begin{minipage}{0.92\textwidth}
        \footnotesize
        \textbf{Identitas Pengusul Inovasi:}\\[0.15cm]
        \begin{tabular}{ll}
            \textbf{Nama Tim:} & KKN: Kelompok Kecerdasan Neural \\
            \textbf{Ketua Tim:} & Husni Abdillah \\
            \textbf{Anggota Tim:} & Fatiyya Ilmi Zahra, Gilang Agung Prakoso, \\
            & Naufal Ghifari Afdhala, Arief Abdul Rahman \\
        \end{tabular}
    \end{minipage}

    \vspace{0.5cm}

    \begin{tcolorbox}[colback=blue!5!white,colframe=blue!75!black,title={\footnotesize \textbf{Tautan Akses Luaran \& Artefak Digital (Deliverables)}},arc=2mm]
        \footnotesize
        \begin{itemize}[leftmargin=0.4cm,itemsep=0pt,topsep=0pt]
            ...
            \item \textbf{Live Web Deployment:} \href{http://34.44.169.181}{\texttt{http://34.44.169.181}} (Akses Port 80 GCP VM)
            \item \textbf{Video Proof of Work (PoW):} \href{https://youtu.be/id_video_pow}{\texttt{https://youtu.be/id\_video\_pow}} (\textit{Unlisted})
            \item \textbf{Video Promosi Karya:} \href{https://youtu.be/id_video_promosi}{\texttt{https://youtu.be/id\_video\_promosi}} (\textit{Public})
        \end{itemize}
    \end{tcolorbox}

    \vfill
    {\footnotesize \textbf{INDONESIA --- 2026}\par}
\end{titlepage}
