...
% --- WARNA BRAND SAKAPINTA (TAILWIND PALETTE) ---
\definecolor{sakapintaPrimary}{HTML}{0058C3}
\definecolor{sakapintaCyan}{HTML}{00CED1}
\definecolor{sakapintaDark}{HTML}{0F172A}
\definecolor{sakapintaLightBg}{HTML}{F0F6FF}

% --- PENGATURAN HYPERREF & WARNA TAUTAN AKADEMIK ---
\hypersetup{
    colorlinks=true,
    linkcolor=sakapintaPrimary,
    citecolor=sakapintaPrimary,
    urlcolor=sakapintaPrimary,
...
\begin{titlepage}
    ...
    {\Huge \textbf{\color{sakapintaPrimary} SAKAPINTA}\par}
    \vspace{0.25cm}
    ...
    \vspace{0.4cm}
    {\color{sakapintaPrimary}\rule{\linewidth}{1.5pt}}\par
    \vspace{0.3cm}

    \begin{center}
        \footnotesize
        \textbf{\color{sakapintaDark} Nama Tim: KKN (Kelompok Kecerdasan Neural)}\\[0.2cm]
        \textbf{Anggota Tim:}\\[0.1cm]
        1. Husni Abdillah (Ketua Tim)\\[0.06cm]
        2. Fatiyya Ilmi Zahra\\[0.06cm]
        3. Gilang Agung Prakoso\\[0.06cm]
        4. Naufal Ghifari Afdhala\\[0.06cm]
        5. Arief Abdul Rahman\\[0.1cm]
    \end{center}

    \vspace{0.3cm}

    \begin{tcolorbox}[colback=sakapintaLightBg,colframe=sakapintaPrimary,title={\footnotesize \textbf{Tautan Akses Luaran \& Artefak Digital}},arc=1.5mm]
        \footnotesize
        \begin{itemize}[leftmargin=0.4cm,itemsep=1pt,topsep=0pt]
            ...
            \item \textbf{Video Proof of Work:} \href{https://tinyurl.com/video-proof-of-work-sakapinta}{\texttt{https://tinyurl.com/video-proof-of-work-sakapinta}}
            \item \textbf{Video Promosi Karya:} \href{https://tinyurl.com/video-promosi-sakapinta}{\texttt{https://tinyurl.com/video-promosi-sakapinta}}
        \end{itemize}
    \end{tcolorbox}
    \vfill
\end{titlepage}
...
Usaha Mikro, Kecil, dan Menengah (UMKM) merupakan tulang punggung perekonomian Indonesia (\textit{backbone of the economy}). Sektor UMKM menyerap sebagian besar angkatan kerja nasional serta berkontribusi signifikan terhadap pembentukan Produk Domestik Bruto (PDB) \citep{bps2023profil}. Di dalam struktur tersebut, sektor perdagangan ritel dan grosir barang kebutuhan pokok (sembako) memegang peranan krusial sebagai urat nadi distribusi konsumsi masyarakat sehari-hari \citep{bi2023laporan}.
